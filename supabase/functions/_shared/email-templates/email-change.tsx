...
export const EmailChangeEmail = ({
  ...
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Confirma el cambio de correo en YORMIT</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Has solicitado cambiar la dirección de correo de tu cuenta en{' '}
          <strong>YORMIT</strong> de{' '}
        ...
        <Text style={text}>
          Pulsa el botón para confirmar el cambio:
        </Text>
