...
type TranslationKeys = {
  ...
  landingPreviewDesc: string;
  landingPreviewDashboard: string;
  landingPreviewDashboardDesc: string;
  landingPreviewExpenses: string;
  landingPreviewExpensesDesc: string;
  landingPreviewChat: string;
  landingPreviewChatDesc: string;
  landingBenefitsTitle: string;
  landingBenefitsDesc: string;
  landingBenefitCentralized: string;
  landingBenefitCentralizedDesc: string;
  landingBenefitCollaboration: string;
  landingBenefitCollaborationDesc: string;
  landingBenefitPrivate: string;
  landingBenefitPrivateDesc: string;
  landingBenefitMultilang: string;
  landingBenefitMultilangDesc: string;
...
const translations: Record<Language, TranslationKeys> = {
  es: {
    ...
    landingHeroTitle: "Tú viaje perfecto,",
    landingHeroHighlight: "todo en una app",
    landingHeroDesc: "YORMIT es la plataforma que centraliza toda la información de tú viaje en grupo: alojamientos, transportes, gastos, actividades y mucho más. Sin caos, sin estrés.",
    ...
    landingFeatureTransportDesc: "Vuelos, trenes, buses… todo organizado con horarios y billetes adjuntos.",
    landingFeatureActivities: "Actividades",
    landingFeatureActivitiesDesc: "Planifica el itinerario día a día con horarios, ubicaciones y entradas.",
    landingFeatureExpenses: "Gastos compartidos",
    landingFeatureExpensesDesc: "Registra gastos, divide cuentas y lleva un balance claro entre todos.",
    landingFeatureChat: "Chat grupal",
    landingFeatureChatDesc: "Comunícate con tu grupo en tiempo real sin salir de la plataforma.",
    landingFeaturePhotos: "Fotos",
    landingFeaturePhotosDesc: "Sube y comparte las mejores fotos del viaje con todos los miembros.",
    landingFeatureWeather: "Meteorología",
    landingFeatureWeatherDesc: "Consulta la previsión del tiempo en destino para planificar mejor.",
    landingFeaturePhones: "Teléfonos útiles",
    landingFeaturePhonesDesc: "Accede rápidamente a números de emergencia y contactos del destino.",
    landingPreviewTitle: "Así se ve por dentro",
    landingPreviewDesc: "Una interfaz limpia y pensada para que organizar sea un placer.",
    landingPreviewDashboard: "Dashboard del viaje",
    landingPreviewDashboardDesc: "Vista general con fechas, miembros y accesos directos a cada sección.",
    landingPreviewExpenses: "Gastos compartidos",
    landingPreviewExpensesDesc: "Registra quién paga, divide entre los miembros y visualiza balances.",
    landingPreviewChat: "Chat en tiempo real",
    landingPreviewChatDesc: "Mensajes instantáneos con tu grupo sin salir de la plataforma.",
    landingBenefitsTitle: "¿Por qué YORMIT?",
    landingBenefitsDesc: "Diseñado para hacerte la vida más fácil cuando viajas en grupo.",
    landingBenefitCentralized: "Todo centralizado",
    landingBenefitCentralizedDesc: "Olvídate de WhatsApps interminables, hojas de cálculo y notas dispersas. Todo en un solo sitio.",
    landingBenefitCollaboration: "Colaboración real",
    landingBenefitCollaborationDesc: "Cada miembro del grupo puede aportar, consultar y organizar. Sin depender de una sola persona.",
    landingBenefitPrivate: "Privado y seguro",
    landingBenefitPrivateDesc: "Cada viaje es privado. Solo los miembros invitados tienen acceso a la información.",
    landingBenefitMultilang: "Multiidioma",
    landingBenefitMultilangDesc: "Disponible en 7 idiomas para que cada viajero se sienta como en casa.",
  ...
  en: {
    ...
    landingHeroTitle: "Your perfect trip,",
    landingHeroHighlight: "all in one app",
    landingHeroDesc: "YORMIT is the platform that centralizes all information for your group trip: accommodation, transport, expenses, activities and much more. No chaos, no stress.",
    ...
    landingFeatureTransportDesc: "Flights, trains, buses… all organized with schedules and attached tickets.",
    landingFeatureActivities: "Activities",
    landingFeatureActivitiesDesc: "Plan your day-by-day itinerary with times, locations and tickets.",
    landingFeatureExpenses: "Shared expenses",
    landingFeatureExpensesDesc: "Track expenses, split bills and keep a clear balance among everyone.",
    landingFeatureChat: "Group chat",
    landingFeatureChatDesc: "Communicate with your group in real time without leaving the platform.",
    landingFeaturePhotos: "Photos",
    landingFeaturePhotosDesc: "Upload and share the best trip photos with all members.",
    landingFeatureWeather: "Weather",
    landingFeatureWeatherDesc: "Check the weather forecast at your destination to plan better.",
    landingFeaturePhones: "Useful phones",
    landingFeaturePhonesDesc: "Quick access to emergency numbers and destination contacts.",
    landingPreviewTitle: "See what it looks like inside",
    landingPreviewDesc: "A clean interface designed to make organizing a pleasure.",
    landingPreviewDashboard: "Trip Dashboard",
    landingPreviewDashboardDesc: "Overview with dates, members and quick access to each section.",
    landingPreviewExpenses: "Shared expenses",
    landingPreviewExpensesDesc: "Record who pays, split among members and view balances.",
    landingPreviewChat: "Real-time chat",
    landingPreviewChatDesc: "Instant messages with your group without leaving the platform.",
    landingBenefitsTitle: "Why YORMIT?",
    landingBenefitsDesc: "Designed to make your life easier when traveling in a group.",
    landingBenefitCentralized: "All centralized",
    landingBenefitCentralizedDesc: "Forget endless WhatsApps, spreadsheets and scattered notes. Everything in one place.",
    landingBenefitCollaboration: "Real collaboration",
    landingBenefitCollaborationDesc: "Every group member can contribute, consult and organize. No depending on one person.",
    landingBenefitPrivate: "Private and secure",
    landingBenefitPrivateDesc: "Each trip is private. Only invited members have access to the information.",
    landingBenefitMultilang: "Multilingual",
    landingBenefitMultilangDesc: "Available in 7 languages so every traveler feels at home.",
