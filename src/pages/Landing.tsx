      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 py-24 md:py-36 lg:py-44">
          <div className="max-w-2xl mx-auto text-center">
            <div className="text-8xl md:text-9xl font-extrabold tracking-wider uppercase flex items-center justify-center mb-4" style={{ color: 'hsl(182 50% 62%)', WebkitTextStroke: '2px black', textShadow: '0 0 4px rgba(0,0,0,0.5)' }}>
              Y<Luggage className="h-20 w-20 md:h-24 md:w-24" strokeWidth={0.8} stroke="black" fill="hsl(182 50% 62%)" />RMIT
            </div>
