  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <button
        ...
        className="fixed bottom-32 right-5 z-50 flex items-center gap-1.5 rounded-full bg-primary px-3 py-2 text-primary-foreground shadow-lg hover:bg-primary/90 transition-colors text-xs font-semibold"
      >
