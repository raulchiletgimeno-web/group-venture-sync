...
import {
  ...
  Zap, HeartHandshake, ListChecks, Users, Clock, HelpCircle, Download, Star, StarHalf
} from "lucide-react";
      ...
      <div className="relative overflow-hidden">
        ...
        <section className="relative">
          <div className="max-w-5xl mx-auto px-5 py-16 md:py-24 lg:py-32">
            ...
            {/* Testimonials strip — premium social proof inside hero */}
            <div className="mt-12 md:mt-14 -mx-5 sm:mx-0">
              <div
                ...
                {[
                  ...
                  >
                    <div className="flex gap-0.5 mb-3" aria-label={`${r.rating} stars`}>
                      ...
                      {r.rating % 1 !== 0 && (
                        <StarHalf className="h-3.5 w-3.5 text-yellow-400 fill-yellow-400" />
                      )}
                    </div>
                    <p className="text-sm text-white/95 leading-relaxed font-medium flex-1 [text-shadow:_0_1px_4px_rgba(0,0,0,0.3)]">
                      &ldquo;{r.quote}&rdquo;
                    </p>
                    <p className="mt-3 text-xs font-semibold text-white/70">— {r.name}</p>
                  </div>
                ))}
              </div>
            </div>
