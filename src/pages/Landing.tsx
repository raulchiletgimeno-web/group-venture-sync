      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 py-24 md:py-36 lg:py-44">
          <div className="max-w-2xl">
            <div className="text-7xl font-extrabold tracking-wider uppercase flex items-center mb-4" style={{ color: 'hsl(182 50% 62%)' }}>
              Y<Luggage className="h-16 w-16" strokeWidth={2.5} />RMIT
            </div>
