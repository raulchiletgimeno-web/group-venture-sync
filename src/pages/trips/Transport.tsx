...
const Transport = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setForm({ type: "flight", departure_location: "", arrival_location: "", departure_datetime: "", arrival_datetime: "", booking_reference: "", notes: "" });
    setOpen(false);
    fetchItems();
    toast({ title: "Transporte añadido" });
  };
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {isCreator && (
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              <DialogHeader><DialogTitle>Añadir transporte</DialogTitle></DialogHeader>
